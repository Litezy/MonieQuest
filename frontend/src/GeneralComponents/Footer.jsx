        ...
        <div className='grid md:grid-cols-2 grid-cols-1 gap-8'>
          <div className='flex flex-col gap-4'>
            <div className='w-full h-fit p-5 bg-slate-100 border-b flex flex-col gap-2 text-sm'>
              <div className='font-semibold'>Please feel free to contact our Corporate team on:</div>
              <div className='flex items-center gap-2'>
                <AiOutlineMail />
                <span className='text-blue-500'>corporate@gowithgeo.com</span>
              </div>
              <div className='flex items-center gap-2'>
                <LuPhone />
                <span className='text-blue-500'>09087654327</span>
                <button className='bg-blue-600 w-fit h-fit p-2 text-xs rounded-md text-white'>Request a call now</button>
              </div>
            </div>
