    ...
    return (
        <div className='flex flex-col gap-2'>
            ...
            <div className='relative'>
                <input className={`outline-none border border-gray-400 bg-transparent w-full h-fit py-3 px-4 lg:text-sm text-base rounded-xl ${className?.input}`} name={name} value={value} placeholder={placeholder} onChange={onChange} type={`${eye ? 'text' : 'password'}`}></input>
