        ...
        <div className='w-11/12 mx-auto text-lg mt-5 '>
          ...
          <div className="flex text-gray-300 items-start gap-3 flex-col mt-10">
            ...
            <div className="w-full flex flex-col">
              ...
              <div className="w-11/12 ml-10 ">
                {Policytutils.slice(3, Policytutils.length).map((item, i) => {
                  return (
                    <ul key={i} className='mb-2 text-gray-300 flex flex-col lg:flex-row gap-1  items-start'>
                      <li className='list-disc '>{item.desc}</li>
                    </ul>
                  )
                })}
              </div>
            ...
            <div className="flex flex-col w-full gap-3">
              ...
              <div className="">Cookies help us personalize your experience. You can choose to disable cookies in your browser settings, though this may impact functionality.</div>
            </div>
            <div className="flex flex-col w-full gap-3 lg:gap-2">
              <div className="text-lightgreen">4. Third-Party Services</div>
              <div className="">Third-party providers may help us analyze usage patterns or deliver parts of our service. They are bound by confidentiality agreements and cannot use your information for any other purpose.</div>
            </div>
            <div className="flex flex-col w-full gap-3 lg:gap-2">
              <div className="text-lightgreen">5. Security</div>
              <div className="">We implement industry-standard measures to protect your information. However, no system is completely secure, and we advise caution when sharing sensitive details.</div>
            </div>
            <div className="flex flex-col w-full gap-3 lg:gap-2">
              <div className="text-lightgreen">6. Updates to this Policy</div>
              <div className="">We may update this policy from time to time. Changes will be reflected on this page, and significant updates will be communicated via email or platform notifications.</div>
            </div>
          </div>
        </div>
      </div>
