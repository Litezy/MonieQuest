                        ...
                        <div className='grid md:grid-cols-2 grid-cols-1 md:gap-10 gap-6'>
                            ...
                            <div className='flex flex-col gap-6'>
                                ...
                                <div className='flex flex-col'>
                                    ...
                                    <FormInput placeholder='Main header' name='main_header_subtitle' value={forms.main_header_subtitle} onChange={formHandler} />
                                </div>
                                <div className='flex flex-col'>
                                    <div className='text-lightgreen capitalize font-medium'>*main header content:</div>
                                    <FormInput formtype='textarea' placeholder='Main header' name='main_header_content' value={forms.main_header_content} onChange={formHandler} />
                                </div>
                            </div>
                            <div className='flex  flex-col gap-6'>
                                <div className='flex flex-col'>
                                    <div className='text-lightgreen capitalize font-medium'>*first paragraph subtitle:</div>
                                    <FormInput placeholder='First paragraph' name='first_paragraph_subtitle' value={forms.first_paragraph_subtitle} onChange={formHandler} />
                                </div>
                                <div className='flex flex-col'>
                                    <div className='text-lightgreen capitalize font-medium'>*first paragraph content:</div>
                                    <FormInput formtype='textarea' placeholder='First paragraph' name='first_paragraph_content' value={forms.first_paragraph_content} onChange={formHandler} />
                                </div>
                                <div className='flex flex-col'>
                                    <div className='text-lightgreen capitalize font-medium'>*second paragraph subtitle:</div>
                                    <FormInput placeholder='Second paragraph' name='second_paragraph_subtitle' value={forms.second_paragraph_subtitle} onChange={formHandler} />
                                </div>
                                <div className='flex flex-col'>
                                    <div className='text-lightgreen capitalize font-medium'>*second paragraph content:</div>
                                    <FormInput formtype='textarea' placeholder='Second paragraph' name='second_paragraph_content' value={forms.second_paragraph_content} onChange={formHandler} />
                                </div>
                                <label className='cursor-pointer w-full'>
                            ...
                            <div className='flex flex-col gap-6'>
                                <div className='flex flex-col'>
                                    ...
                                    <FormInput placeholder='Extra paragraph' name='extras_subtitle' value={forms.extras_subtitle} onChange={formHandler} />
                                </div>
                                <div className='flex flex-col'>
                                    <div className='text-lightgreen capitalize font-medium'>*extras content:</div>
                                    <FormInput formtype='textarea' placeholder='Extra paragraph' name='extras_content' value={forms.extras_content} onChange={formHandler} />
                                </div>
                                <label className='cursor-pointer w-full'>
