                        ...
                        <div className="w-full  lg:w-2/3 mx-auto flex items-center justify-center">
                            <div className="flex w-full  mx-auto mt-5 items-start gap-5 flex-col">
                                <div className="flex items-start gap-2 flex-col w-full">
                                    ...
                                    <div className="text-red-600 text-xs">Please Note: you can only buy a minimum of ${forms.minimum} and maximum of ${forms.limit}. verify your account to increase limit</div>
                                </div>
