              ...
              <div className='flex gap-3 items-baseline'>
                ...
                <div className='flex flex-col gap-3'>
                  ...
                  <div className='flex flex-col gap-2'>
                    ...
                    <textarea className='outline-none border border-white lg:text-sm text-base w-72 h-fit bg-transparent resize-none' placeholder='Explain what your tool can do here...' name='textField' value={form.textField} onChange={formHandler}></textarea>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className='flex gap-2'>
            ...
            <div className='flex flex-col gap-2'>
              ...
              <div className='flex'>
                ...
                <input className='outline-none border border-white text-base w-72 h-fit p-3 bg-transparent iptt' placeholder='Amount' name='amount' value={form.amount} onChange={formHandler}></input>
              </div>
            </div>
          </div>
          <div className='flex gap-2'>
