...
exports.getDashboardInfos = async (req, res) => {
    try {
        ...
        const data = [
            ...
            { title: 'total Crypto Bought', value: totalCryptobuys, color: 'yellow' },
            { title: 'total Crypto Sold', value: totalCryptosells, color: 'blue' },
            { title: 'total Giftcard Sold', value: totalGiftcardSells, color: 'orange' },
