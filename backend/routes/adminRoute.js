...
router.post('/delete-closed-airdrop', AdminMiddleware, DeleteClosedAirdrops)
...
// router.put('/delete_blog_img/:id', AdminMiddleware, deleteSingleImage)
