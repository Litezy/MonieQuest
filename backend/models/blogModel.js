module.exports = (sequelize, DataTypes) => {
    return sequelize.define('blog', {
        ...
        main_header_content: { type: DataTypes.TEXT },
        first_paragraph_title: { type: DataTypes.TEXT },
        first_paragraph_content: { type: DataTypes.TEXT },
        second_paragraph_title: { type: DataTypes.TEXT },
        second_paragraph_content: { type: DataTypes.TEXT },
        second_paragraph_image: { type: DataTypes.STRING, allowNull: true },
        extras_title: { type: DataTypes.TEXT },
        extras_content: { type: DataTypes.TEXT },
