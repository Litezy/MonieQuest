...
const Mailing = async ({ eTitle, eBody, account, subject }) => {
    ...
    const content = `
        <div style="padding-right: 1rem; padding-left: 1rem; margin-top: 2.5rem">
          ...
          <div style="margin-top: 3rem; padding-top: 1rem; padding-bottom: 1rem; border-top: 1px solid #00fe5e;">
             <div style="font-weight: bold; color: #00fe5e; text-align: center">Stay connected!</div>
             <div style="margin-top: 1rem">
                 <a href=${Socials.fb} style="padding-left: 6rem"><img src='https://res.cloudinary.com/dnz3cbnxr/image/upload/v1725461777/myfolder/jhjssvvwqe85g7m6ygoj.png' style="width: 1.1rem; height: 1.1rem" /></a>
                 ...
                 <a href=${Socials.x} style="padding-left: 1rem"><img src='https://res.cloudinary.com/dnz3cbnxr/image/upload/v1738016436/myfolder/ta7yzo70asd5typ8lwyx.png' style="width: 1rem; height: 1rem" /></a>
             ...
             <div style="margin-top: 1rem;  width: fit-content; height: fit-content; background-color: #172029; color: #94A3B8; font-size: 0.75rem; padding-right: 2rem; padding-left: 2rem; padding-top: 0.75rem; padding-bottom: 0.75rem; display: flex">
                 ...
                 <span>${webName} 2024, All rights reserved.</span>
              </div>
          </div>
        </div>
    `
